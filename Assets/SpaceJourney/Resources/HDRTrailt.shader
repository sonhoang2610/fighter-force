...
Shader "HDRTrail"{   
	Properties {   
		...
		[HDR]_Color_color1 ("Color color1", Color) = (1,1,1,1)
		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				//====================================
				//============ color1 ============   
				float4 color_color1 = _Color_color1;
				...
				result = lerp(result,float4(color_color1.rgb,rootTexColor.a),clamp(color_color1.a*1*((1)),0,1));    
