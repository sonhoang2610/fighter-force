            ...
            set {
                ...
                for(int i = 0; i < value.Info.skills.Count; ++i)
                {
                    ...
                    if (value.UpgradeSkill.ContainsKey(value.Info.skills[i].Info.ItemID))
                    {
                        ...
                        {
                            currentLevel = value.UpgradeSkill[value.Info.skills[i].Info.ItemID] == 0 ? 0 : value.UpgradeSkill[value.Info.skills[i].Info.ItemID],
                    ...
                    else
                    {
                        ...
                        pDatas.Add(pSkill);
                        value.UpgradeSkill.Add(value.Info.skills[i].Info.ItemID, 0);
                    }
                }
                if (ischange)
                {
